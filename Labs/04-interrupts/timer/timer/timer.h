...
#define TIM2_overflow_16u()		TCCR0B &= ~((1<<CS02) | (1<<CS01)); TCCR0B |= (1<<CS00);
#define TIM2_overflow_128u()	TCCR0B &= ~((1<<CS02) | (1<<CS00)); TCCR0B |= (1<<CS01);
#define TIM2_overflow_1ms()		TCCR0B &= ~(1<<CS02); TCCR0B |= (1<<CS01) | (1<<CS00);
#define TIM2_overflow_4ms()		TCCR0B &= ~((1<<CS01) | (1<<CS00)); TCCR0B |= (1<<CS02);
#define TIM2_overflow_16ms()	TCCR0B &= ~(1<<CS01); TCCR0B |= ((1<<CS02) | (1<<CS00));

#define TIM2_overflow_interrupt_enable()	TIMSK0 |= (1<<TOIE1);
#define TIM2_overflow_interrupt_disable()	TIMSK0 &= ~(1<<TOIE1);
#endif